...
Этот Magisk-модуль заменяет стандартную анимацию загрузки на стильную киберпанковую анимацию, вдохновленную **OnePlus 8T Cyberpunk 2077 Edition** и адаптированную специально для **POCO**. Опционально включен кастомный **Splash Screen**.
